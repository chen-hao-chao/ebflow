...
def inpainting(config, model, trans):
    ...
    from ebflow.datasets.kmnist import load_data
    ...
    for x_, _ in test_loader:
        ...
        img = trans.reverse(x)
        torchvision.utils.save_image(img / 256., "results_inpainting/inpainting_fc_celeb.png", nrow=10, padding=2, normalize=False)
        break
